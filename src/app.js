...
import session from 'express-session'; //NUEVO importar express-session
import connectMongo from 'connect-mongo'; //NUEVO Importar connect-mongo para almacenar sesiones en MongoDB
import {ProductManager} from './ProductManager.js';
import {Server} from 'socket.io';
import CartManager from './CartManager.js';
import Product from './models/Product.js'; //NUEVO importa el modelo Product
